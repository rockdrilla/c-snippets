...
#define UVECTOR_DEFINE_TYPE0(user_t, index_t, value_t) \
	...
	_UVECTOR_PROCINT_GET_BY_VAL(user_t, index_t, value_t) \
	_UVECTOR_PROC_GET_BY_VAL(user_t, index_t, value_t) \
	_UVECTOR_PROCINT_SET_BY_PTR(user_t, index_t, value_t) \
	_UVECTOR_PROC_SET_BY_PTR(user_t, index_t, value_t) \
	_UVECTOR_PROCINT_SET_BY_VAL(user_t, index_t, value_t) \
	_UVECTOR_PROC_SET_BY_VAL(user_t, index_t, value_t) \
	_UVECTOR_PROC_APPEND_BY_PTR(user_t, value_t) \
	_UVECTOR_PROC_APPEND_BY_VAL(user_t, value_t) \
